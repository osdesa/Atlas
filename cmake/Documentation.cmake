function(atlas_add_documentation)
    ...
    set(ATLAS_DOXYGEN_MILESTONE_9_PAGE "${PROJECT_SOURCE_DIR}/docs/milestone-9-preemptive-style-priority-scheduling.md")
    set(ATLAS_DOXYGEN_MILESTONE_10_PAGE "${PROJECT_SOURCE_DIR}/docs/milestone-10-benchmarking-framework.md")
    set(ATLAS_DOXYGEN_MILESTONE_11_PAGE "${PROJECT_SOURCE_DIR}/docs/milestone-11-baseline-comparisons.md")
    ...
    file(TO_CMAKE_PATH "${ATLAS_DOXYGEN_MILESTONE_9_PAGE}" ATLAS_DOXYGEN_MILESTONE_9_PAGE)
    file(TO_CMAKE_PATH "${ATLAS_DOXYGEN_MILESTONE_10_PAGE}" ATLAS_DOXYGEN_MILESTONE_10_PAGE)
    file(TO_CMAKE_PATH "${ATLAS_DOXYGEN_MILESTONE_11_PAGE}" ATLAS_DOXYGEN_MILESTONE_11_PAGE)
