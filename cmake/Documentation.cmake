function(atlas_add_documentation)
    ...
    set(ATLAS_DOXYGEN_EVALUATION_PAGE "${PROJECT_SOURCE_DIR}/docs/milestone-13-evaluation.md")
    set(ATLAS_DOXYGEN_VALIDATION_PAGE "${PROJECT_SOURCE_DIR}/docs/milestone-15-validation.md")
    set(ATLAS_DOXYGEN_FINAL_EVALUATION_PAGE "${PROJECT_SOURCE_DIR}/docs/milestone-16-evaluation.md")
    set(ATLAS_DOXYGEN_MILESTONES_PAGE "${PROJECT_SOURCE_DIR}/docs/remaining-milestone.md")
    ...
    file(TO_CMAKE_PATH "${ATLAS_DOXYGEN_EVALUATION_PAGE}" ATLAS_DOXYGEN_EVALUATION_PAGE)
    file(TO_CMAKE_PATH "${ATLAS_DOXYGEN_VALIDATION_PAGE}" ATLAS_DOXYGEN_VALIDATION_PAGE)
    file(TO_CMAKE_PATH "${ATLAS_DOXYGEN_FINAL_EVALUATION_PAGE}" ATLAS_DOXYGEN_FINAL_EVALUATION_PAGE)
    file(TO_CMAKE_PATH "${ATLAS_DOXYGEN_MILESTONES_PAGE}" ATLAS_DOXYGEN_MILESTONES_PAGE)
    ...
    set(
        ATLAS_UML_DIAGRAMS
        "${ATLAS_UML_OUTPUT_DIRECTORY}/task_snapshot.puml"
