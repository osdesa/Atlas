function(atlas_compile_shader target_name shader_source output_variable)
    ...
    add_custom_command(
        ...
        COMMAND "${ATLAS_GLSLC_EXECUTABLE}" --target-env=vulkan1.1 "${shader_source}" -o "${shader_output}"
        COMMAND "${ATLAS_SPIRV_VAL_EXECUTABLE}" --target-env vulkan1.1 "${shader_output}"
